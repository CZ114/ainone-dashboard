...
export const en = {
  ...
  chat: {
    ...
    workflowPanel: {
      title: 'Workflows',
      selectPlaceholder: 'Select a workflow…',
      run: 'Run',
      running: 'Running…',
      stop: 'Stop',
      noInputs: 'No inputs required',
      autoTag: 'auto',
      loadFailed: (msg: string): string => `Failed to load workflows: ${msg}`,
      runLabel: 'run',
      done: 'Done',
      failed: 'Failed',
      aborted: 'Stopped',
      loopBreak: 'early exit',
      humanTitle: 'Waiting for your input',
      humanPlaceholder: 'Type your answer…',
      submit: 'Submit',
      answered: 'Submitted',
      submitFailed: (msg: string): string => `Submit failed: ${msg}`,
      refsTitle: (agent: string): string => `References · ${agent}`,
      refsQuery: (query: string): string => `query: ${query}`,
      refsScore: (score: string): string => `similarity ${score}`,
      stoppedNote: 'Stopped — recorded as aborted',
      history: 'Run history',
      ...
      deleteFailed: (msg: string): string => `Delete failed: ${msg}`,
      detailLoadFailed: (msg: string): string => `Failed to load run: ${msg}`,
      stepsMeta: (steps: number, secs: string, time: string): string =>
        `${steps} steps · ${secs}s · ${time}`,
    },
    errors: {
      label: 'Error',
...
export const zh: Strings = {
  ...
  chat: {
    ...
    workflowPanel: {
      ...
      noInputs: '无需输入',
      autoTag: '对话触发',
      loadFailed: (msg: string): string => `工作流加载失败：${msg}`,
      runLabel: 'run',
      done: '完成',
      failed: '失败',
      aborted: '已中止',
      ...
      submit: '提交',
      answered: '已提交',
      submitFailed: (msg: string): string => `提交失败：${msg}`,
      refsTitle: (agent: string): string => `引用 · ${agent}`,
      refsQuery: (query: string): string => `检索：${query}`,
      refsScore: (score: string): string => `相似度 ${score}`,
      stoppedNote: '已停止 — 记录为中止',
      history: '历史运行',
      historyEmpty: '暂无运行记录',
      historyLoading: '加载中…',
      refresh: '刷新',
      ...
      confirmDelete: (name: string): string =>
        `删除运行「${name}」？此操作不可撤销。`,
      deleteFailed: (msg: string): string => `删除失败：${msg}`,
      detailLoadFailed: (msg: string): string => `运行详情加载失败：${msg}`,
      stepsMeta: (steps: number, secs: string, time: string): string =>
        `${steps} 步 · ${secs}s · ${time}`,
    },
    errors: {
