...
export interface AppConfig {
  debugMode: boolean;
  staticPath: string;
  cliPath: string; // Legacy field (was the Claude CLI path); unused since the agent-service migration
}
...
export function createApp(
  ...
  // Store AbortControllers for diary manual-trigger runs. Chat aborts
  // are proxied to the Python agent service and no longer live here.
  ...
  // Direct-streaming endpoint for the /call voice page. Talks straight
  // to the Anthropic-compatible API — see comment in
